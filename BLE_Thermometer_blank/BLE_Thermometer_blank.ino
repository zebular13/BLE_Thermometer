...
BLEService SERVICENAME("SERVICE NUMBER"); // Add your service number here, and call it anything

// BLE temperature Measurement Characteristic"
BLECharacteristic CHARACTERISTICNAME("CHARACTERISTIC NUMBER",  // add your characteristic number here and call it anything
...
void setup() {
  ...
  blePeripheral.addAttribute(SERVICENAME);   // Add the BLE temperatureservice
  blePeripheral.addAttribute(CHARACTERISTICNAME); // add the RSC Measurement characteristic
...
void updateTemperature() {
  ...
  */
  // Get the (raw) value of the temperature sensor.
    ...
    const unsigned char temperatureCharArray[2] = { 0, (char)temperature}; //convert the temperature to an array
    CHARACTERISTICNAME.setValue(temperatureCharArray, 2);  // and update the characteristic
    delay(1000);
}
